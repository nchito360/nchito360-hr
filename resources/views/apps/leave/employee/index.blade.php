...
<div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($leave->status === 'pending')
                                            <a href="{{ route('leave.edit', $leave->id) }}" class="btn btn-sm btn-outline-primary mb-1">Edit</a>
                                            ...
                                            <form action="{{ route('leave.destroy', $leave->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this application?');">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=Africa%2FWindhoek" style="border:solid 1px #ccc" width="100%" height="600" frameborder="0" scrolling="no"></iframe>
        </div>
    </div>
