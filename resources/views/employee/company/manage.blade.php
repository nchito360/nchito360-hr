                        ...
                        <tbody>
                            @foreach ($joinRequests as $request)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('employee.company.request.approve', $request->id) }}"
                                            method="POST" class="d-inline">
                                            @csrf
                                            <button class="btn btn-success btn-sm">Approve</button>
                                        </form>
                                        <form action="{{ route('employee.company.request.reject', $request->id) }}"
                                            method="POST" class="d-inline">
                                            @csrf
            ...
            <div class="card p-4 mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="organization_name"
                        value="{{ old('organization_name', $company->organization_name) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="description" rows="3">{{ old('description', $company->description) }}</textarea>
                </div>
            ...
            <div class="card p-4 mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="branches"
                        value="{{ old('branches', implode(',', $company->branches ?? [])) }}">
                </div>
            </div>
            ...
            <div class="card p-4 mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="departments"
                        value="{{ old('departments', implode(',', $company->departments ?? [])) }}">
                </div>
            </div>
